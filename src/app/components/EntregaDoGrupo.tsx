...
function CommentsSection() {
  return (
    <div className="mx-4 mb-6">
      <div className="text-sm font-medium text-gray-900 mb-3">Comentários do Grupo</div>
      <div className="space-y-3 mb-3">
        <div className="flex items-start gap-2">
          <div className="w-8 h-8 bg-gray-200 rounded-full flex-shrink-0" />
          <div className="flex-1">
            <div className="bg-gray-100 rounded-xl p-3">
              <div className="text-xs font-medium text-gray-700 mb-1">Bruno</div>
              <p className="text-sm text-gray-700">
                Pessoal, encontrei um modelo bom de matriz de riscos. Vou compartilhar no workspace.
              </p>
            </div>
            <span className="text-xs text-gray-400 ml-3">há 3 horas</span>
          </div>
        </div>
        <div className="flex items-start gap-2 justify-end">
          <div className="flex-1 flex flex-col items-end">
            <div className="text-white rounded-xl p-3 max-w-[80%]"
              style={{ background: 'linear-gradient(to right, #0F766E, #3B82F6)' }}>
              <p className="text-sm">Ótimo! Já estou revisando o documento.</p>
            </div>
            <span className="text-xs text-gray-400 mr-3">há 1 hora</span>
          </div>
        </div>
      </div>
      <div className="flex items-center gap-2">
        <input type="text" placeholder="Digite uma mensagem..."
          className="flex-1 px-4 py-3 border border-gray-200 rounded-xl bg-white text-sm focus:outline-none focus:border-[#0F766E]" />
        <button className="w-10 h-10 bg-[#3B82F6] text-white rounded-xl flex items-center justify-center flex-shrink-0">
