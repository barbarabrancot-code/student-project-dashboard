...
function StudentGrid({ selectedStudents, setSelectedStudents, favoritedStudents, setFavoritedStudents, setSelectedProfileId }: any) {
  const students = [
    ...
    { id: 2,  name: 'Bruno Costa',   course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 8.8, mbti: 'ENFP', certifications: ['NR-32'],           summary: 'Criou protocolo de auditoria mensal',          available: true,  foto: '/student-project-dashboard/brunocosta-convertido-de-jpg_1_11zon.webp'  },
    { id: 3,  name: 'Carlos Lima',   course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 7.9, mbti: 'ISTJ', certifications: ['NR-09', 'RDC 222'], summary: 'Mapeou riscos biológicos do laboratório',       available: false, foto: '/student-project-dashboard/carloslima-convertido-de-jpg_17_11zon.webp'  },
    { id: 4,  name: 'Diana Souza',   course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 9.3, mbti: 'ENFJ', certifications: ['NR-32', 'NR-09'],   summary: 'Sistema de classificação com QR codes',        available: true,  foto: '/student-project-dashboard/dianasouza-convertido-de-jpg_18_11zon.webp'  },
    { id: 5,  name: 'Eduardo Alves', course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 8.5, mbti: 'INTP', certifications: ['NR-32'],           summary: 'App mobile para registro de incidentes',      available: true,  foto: '/student-project-dashboard/eduardoalves-convertido-de-jpg_15_11zon.webp' },
    { id: 6,  name: 'Fernanda Reis', course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 9.0, mbti: 'ESFJ', certifications: ['NR-09', 'RDC 222'], summary: 'Programa de treinamento continuado',            available: true,  foto: '/student-project-dashboard/fernandareis_3_11zon.webp' },
    { id: 7,  name: 'Gabriel Nunes', course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 8.2, mbti: 'ISTP', certifications: ['NR-32'],           summary: 'Dashboard de indicadores de segurança',       available: true,  foto: '/student-project-dashboard/gabrielnunes-convertido-de-jpg_16_11zon.webp' },
    { id: 8,  name: 'Helena Campos', course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 8.9, mbti: 'INFJ', certifications: ['NR-09'],           summary: 'Matriz de riscos digitalizada',               available: false, foto: '/student-project-dashboard/helenacampos_11_11zon.webp' },
    { id: 9,  name: 'Igor Santos',   course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 7.8, mbti: 'ESTP', certifications: ['NR-32', 'RDC 222'], summary: 'Checklist de conformidade regulatória',         available: true,  foto: '/student-project-dashboard/igorsantos-convertido-de-jpg_14_11zon.webp' },
    { id: 10, name: 'Julia Moraes',  course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 9.2, mbti: 'INFP', certifications: ['NR-32', 'NR-09'],   summary: 'Protocolo de emergência biológica',            available: true,  foto: '/student-project-dashboard/juliamoraes_4_11zon.webp' },
    { id: 11, name: 'Lucas Barros',  course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 8.4, mbti: 'ENTJ', certifications: ['NR-09'],           summary: 'Sistema de gestão de EPIs',                   available: true,  foto: '/student-project-dashboard/lucasbarros-convertido-de-jpg_13_11zon.webp' },
    { id: 12, name: 'Mariana Pinto', course: 'Segurança no trabalho', institution: 'Escola Técnica Geração', grade: 8.7, mbti: 'ISFP', certifications: ['NR-32', 'RDC 222'], summary: 'Plano de resposta a incidentes',               available: true,  foto: '/student-project-dashboard/marianapinto_2_11zon.webp' }
  ];
