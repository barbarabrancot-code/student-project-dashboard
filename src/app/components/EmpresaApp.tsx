...
const grupos: Grupo[] = [
  {
    ...
    membros: [
      ...
      { iniciais: 'BC', nome: 'Bruno Costa',  cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/brunocosta-convertido-de-jpg_1_11zon.webp' },
      { iniciais: 'CL', nome: 'Carlos Lima',  cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/carloslima-convertido-de-jpg_17_11zon.webp' },
      { iniciais: 'DS', nome: 'Diana Santos', cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/dianasouza-convertido-de-jpg_18_11zon.webp' },
    ],
  },
  {
    id: 2, nome: 'Grupo 2', status: 'Em andamento',
    membros: [
      { iniciais: 'MF', nome: 'Mariana Ferreira', cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/marinaferreira_10_11zon.webp' },
      { iniciais: 'PG', nome: 'Pedro Gomes',      cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/pedrogomes_7_11zon.webp' },
      { iniciais: 'RH', nome: 'Rafael Henrique',  cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/rafaelhenrique_6_11zon.webp' },
    ],
  },
  {
    id: 3, nome: 'Grupo 3', status: 'Em andamento',
    membros: [
      { iniciais: 'TK', nome: 'Thiago Kühl',     cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/thiagokuhl_12_11zon.webp' },
      { iniciais: 'VL', nome: 'Valentina Lima',  cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/valentinalima_9_11zon.webp' },
      { iniciais: 'WM', nome: 'William Martins', cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/williammartins_8_11zon.webp' },
      { iniciais: 'XN', nome: 'Xênia Neves',     cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/xenianeves_5_11zon.webp' },
    ],
  },
  {
    id: 4, nome: 'Grupo 4', status: 'Em andamento',
    membros: [
      { iniciais: 'EA', nome: 'Eduardo Alves',  cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/eduardoalves-convertido-de-jpg_15_11zon.webp' },
      { iniciais: 'FR', nome: 'Fernanda Reis',  cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/fernandareis_3_11zon.webp' },
      { iniciais: 'GN', nome: 'Gabriel Nunes',  cargo: 'Técnico em Segurança do Trabalho', foto: '/student-project-dashboard/gabrielnunes-convertido-de-jpg_16_11zon.webp' },
